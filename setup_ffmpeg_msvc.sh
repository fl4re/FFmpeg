...
PATH=$ToolChainDir:$PATH ./configure --cpu=i686 --toolchain=msvc --enable-shared --disable-gpl --disable-programs --disable-doc --enable-avresample --prefix=./win64 $FL4RE_FFMPEG_CONFIGURE_FLAGS
echo "Done!"
