...
PATH=$ToolChainDir:$PATH ./configure --arch=x86_64 --toolchain=msvc --enable-shared --disable-gpl --disable-programs --disable-doc --enable-avresample --prefix=./win64 $FL4RE_FFMPEG_CONFIGURE_FLAGS
echo "Done!"
